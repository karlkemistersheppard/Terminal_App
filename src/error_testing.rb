...
#Modified existing STDIN.gets.chomp with the below code to ensure that the user must enter a character name before they are able to continue with the program.
